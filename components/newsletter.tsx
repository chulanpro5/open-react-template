          ...
          <div className="relative bg-gray-900 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 text-white mb-2">Cần hỗ trợ ?</h3>
                <p className="text-gray-300 text-lg mb-6">Chúng tôi sẽ liên lạc với bạn ngay trong ngày</p>
                ...
                <form className="w-full lg:w-auto">
                  <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                    ...
                    <a className="btn text-white bg-green-600 hover:bg-green-700 shadow" href="#0">Gửi</a>
                  </div>
                  {/* Success message */}
